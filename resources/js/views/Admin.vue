            ...
            <div class="row">
                <div class="col-md-3">
                    <ul style="list-style-type:none">
                        <li class="active"><button class="btn" @click="setComponent('main')">Quản lý</button></li>
                        <li><button class="btn" @click="setComponent('orders')">Hóa đơn</button></li>
                        <li><button class="btn" @click="setComponent('products')">Sản phẩm</button></li>
                        <li><button class="btn" @click="setComponent('users')">Tài khoản người dùng</button></li>
                    </ul>
                </div>
                <div class="col-md-9">
